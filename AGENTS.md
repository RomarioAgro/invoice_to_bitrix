...
This project is indexed by OntoIndex as **invoice_to_bitrix** (691 symbols, 1078 relationships, 15 execution flows). Use the OntoIndex MCP tools to understand code, assess impact, and navigate safely.
