...
This project is indexed by OntoIndex as **invoice_to_bitrix** (518 symbols, 731 relationships, 11 execution flows). Use the OntoIndex MCP tools to understand code, assess impact, and navigate safely.
