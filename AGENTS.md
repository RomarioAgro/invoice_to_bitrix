...
This project is indexed by OntoIndex as **invoice_to_bitrix** (799 symbols, 1232 relationships, 13 execution flows). Use the OntoIndex MCP tools to understand code, assess impact, and navigate safely.
